...
public class MainActivity extends AppCompatActivity {
    ...
    int[] originalArray = new int[]{
        R.drawable.pict_part_01, R.drawable.pict_part_02, R.drawable.pict_part_03, R.drawable.pict_part_04,
            R.drawable.pict_part_05, R.drawable.pict_part_06, R.drawable.pict_part_07, R.drawable.pict_part_08,
            R.drawable.pict_part_09, R.drawable.pict_part_10, R.drawable.pict_part_11, R.drawable.pict_part_12,
            R.drawable.pict_part_13, R.drawable.pict_part_14, R.drawable.pict_part_15, R.drawable.pict_part_16
    };
